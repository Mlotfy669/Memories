  ...
  return (
    <Card className={classes.card}>
      ...
      <div className={classes.overlay2}>
        <Button style={{ color: 'white' }} size="small" onClick={() => setCurrentId(post._id)}><TbDots fontSize="default" /></Button>
      </div>
      ...
      <CardActions className={classes.cardActions}>
        <Button size="small" color="primary" onClick={() => dispatch(likePost(post._id))}><AiFillLike fontSize="small" /> Like {post.likeCount} </Button>
